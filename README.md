...
This version uses a simple coordinate system and a game loop.
...
1. **Input Handling:** Switched to `bufio.Scanner` for more robust CLI interaction.
2. **Turn Enforcement:** Added logic to prevent moving the opponent's pieces.
3. **Friendly Fire Check:** You can no longer "eat" your own pieces.
4. **UI:** Added a better board border and clear column/row headers for easier coordinate selection.
